...
class HandlerCheck(object):
    """
    Register ourselves as the default Web handler
    """
    def __init__(self, config = None):

        ##Register ourselves as the default handler? - todo: pull from config
        self.register_default = True
    ...
    def _register_default_handler(self):
        ...
        LSSetDefaultRoleHandlerForContentType("public.html", 0x00000002, "is.syndis.vmware_guest_url")
        LSSetDefaultRoleHandlerForContentType("public.xhtml", 0x00000002, "is.syndis.vmware_guest_url")
        LSSetDefaultHandlerForURLScheme("http" , "is.syndis.vmware_guest_url")
        LSSetDefaultHandlerForURLScheme("https", "is.syndis.vmware_guest_url")
...
class VmRunOpenBrowser(object):
    ...
    """
    def __init__(self, config = '~/.vmware_guest_url.cfg'):
        """
...
class AppDelegate(NSObject):
    ...
    def dirty_init(self, config = '~/.vmware_guest_url.cfg'):
        """
        Read in config
        """
